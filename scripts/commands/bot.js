...
module.exports = {
  ...
  "আমাকে এতো না ডেকে বস 𝗠𝗼𝗿𝘀𝗵𝗘𝗱 একটা গফ দে 🙄",
  "জান তোমার নানি'রে আমার হাতে তুলে দিবা-🙊🙆‍♂",
  "চুনা ও চুনা আমার বস MorshEd এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না-😪sawa1",
   "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস MorshEd এর সাথে  প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
   "-আজকে আমার মন ভালো নেই তাই আমারে ডাকবেন না-😪🤧",
  "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস MorshEd ধরতে পারছে না-🐸🥲",
  "কিরে-🫵-তরা নাকি  prem করস-😐🐸-আমারে একটা করাই দিলে কি হয়-🥺",
  "-আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার বস MorshEd কে দান করেন-🥱🐰🍒",
  "-ওরা বলেছিল না পাওয়ার য'ন্ত্র'ণা সারাজীবনের ওরা কেউ বলেনি, পেয়ে হারানোর য'ন্ত্র'ণা জন্মান্তরের!❤️‍🩹☺️",
  "sawa1😬",
  "sawa2😒",
   "jang bal falaba🙂",
        ];
